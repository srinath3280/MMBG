...
const Register = () => {
    ...
    const submitHandler = e => {
        ...
        axios({
            method: 'post',
            url: 'http://localhost:4550/register',
            data: data
        }).then(() => {
    ...
    const sendAudioToBackend = async () => {
        if (audioData) {
            ...
            const audioresponse = await fetch('http://localhost:4550/upload', {
                method: 'POST',
                body: formData,
            });
            if(audioresponse){
        ...
        <div id='registerform'>
            <div id='register'>
                <div id='registerblock1'>
                    <div>
                        <img src="/images/mmbg_logo.webp" alt="" width="75px" height="75px" />
                    </div>
                    <div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="fulladdress" id="textarea" cols="30" rows="3" class="form-control" onChange={changeHandler}></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                    ...
                    <div id='registerblock6'>
                        ...
                        <div id="voice">
                            ...
                            <div>
                                ...
                                {audioData && <span class="btn btn-secondary" onClick={sendAudioToBackend}>Submit</span>}
                            </div>
                        </div>
                    </div>
